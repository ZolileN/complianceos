...
// ── Meta / Facebook JS SDK (Embedded Signup) ───────────────
// Minimal type declarations for window.FB used in the WhatsApp
// Embedded Signup flow. Not exhaustive — only what PraxisOne uses.
