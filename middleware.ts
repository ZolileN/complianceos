...
export const config = {
  matcher: [
     ...
     */
    "/((?!$|login|signup|forgot-password|reset-password|onboard|monitoring|api/auth|api/onboard|api/uploadthing|api/webhooks|api/whatsapp/webhook|api/billing/ozow/webhook|api/billing/stitch/callback|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
